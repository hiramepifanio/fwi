...
#plt.imshow(shot, aspect='auto', extent=[0,shot.shape[1],shot.shape[0]*2,0], cmap='binary')
plt.imshow(shot, aspect='auto', cmap='binary', extent=[0,shot.shape[1],shot.shape[0]*2,0])
