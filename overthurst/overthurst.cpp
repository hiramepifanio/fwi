...
int main() {
    ...
    string script = "overthurst";
    cout << "\nStarting script: " << script << "." << endl;

    // Parameters
    int nz = 187, nx = 801, nt = 3000;                  // Number of grid points and timesteps
    float dz = 25, dx = 25, dt = 0.002;                 // Step and timestep sizes
    ...
    float fp = 8;                                       // Ricker wavelet peak frequency
